    ...
    render() {
        ...
        return (
            <div className='sessionsContainer'>
                ...
                {this.props.mySessions.map(sessions => { 
                    return <SessionCard sessions={sessions} key={sessions.id} 
                    deleteSession={this.props.deleteSession} clientObject={this.props.clientObject} 
